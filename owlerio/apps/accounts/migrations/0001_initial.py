...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('accounts_profile', (
            ...
            ('preference', self.gf('django.db.models.fields.related.OneToOneField')(related_name='profile', unique=True, to=orm['preferences.Preference'])),
        ))
    ...
    models = {
        ...
        'accounts.profile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'preference': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'profile'", 'unique': 'True', 'to': "orm['preferences.Preference']"}),
